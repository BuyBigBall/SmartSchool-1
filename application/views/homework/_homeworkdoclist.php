...
<?php foreach ($docs as $value) { ?>
    ...
    <tr>
        ...
        <td class="mailbox-date pull-right">
        	<?php 
        	if($value['docs']!==''){ ?>
        		 <a class="btn btn-default btn-xs" href="<?php echo base_url(); ?>homework/assigmnetDownload/<?php echo $value['docs']; ?>" title="" data-original-title="<?php echo $this->lang->line('evaluation');?>">
