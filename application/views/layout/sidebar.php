                    ...
                    ?></span> <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('notice_board', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('notification/add'); ?>"><a href="<?php echo base_url(); ?>admin/notification/add"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('compose_new_message'); ?></a></li>
                                <?php
                            }
                            /*
