...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <!-- left column -->
                <form id="form1" action="<?php echo base_url() ?>admin/notification/add"  
                            ...
                            <div class="row">  
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group"><label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                        ...
                                        <!-- <textarea id="compose-textarea" name="org_message" class="form-control" style="height: 300px;display:none">
                                            <?php echo set_value('message'); ?>
                                        </textarea> -->
                                        <span class="text-danger"><?php echo form_error('message'); ?></span>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            <label for="publish_date"><?php echo $this->lang->line('publish_on'); ?></label><small class="req"> *</small>
                                        ...
                                        <label for="sectionlist"><?php echo $this->lang->line('section'); ?></label><small class="req"> *</small>
        ...
        $('#sectionlist').html("");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    {
                        ul_data += '<li style="list-style-type: none;"><input id="section_'+ obj.section_id +'" type="checkbox" name="section_id[]" value="'+ obj.section_id +'" /> <div style="margin-left:25px;margin-top:-22px;"><label for="section_'+ obj.section_id +'" style="cursor:pointer;">' + obj.section + '</label></div></li>';
                    });
