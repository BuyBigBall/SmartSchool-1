                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $student) {
                                            ...
                                            ?>>
                                                ...
                                                <td>
                                                    <a href="#"><?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>
                                                    </a>
                                                </td> 
                                                <?php if ($sch_setting->admission_date) { ?>
                                                    <td><?php if($student["admission_date"]=='0000-00-00' && $student["admission_date"]!=''){
                                                        echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformatFront($student["admission_date"]));
                                                    }  ?></td>
        <?php } ?>
