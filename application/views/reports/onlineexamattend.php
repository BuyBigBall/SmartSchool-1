                ...
                <div class="box removeboxmius">
                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive" id="subject_list">
                            ...
                            <div class="downloadlabel hide"><h3> <?php echo $this->lang->line('exam') . " " . $this->lang->line('attempt') . " " . $this->lang->line('report');
                            ...
                            <table class="table table-striped table-bordered table-hover " id="headerTable">
                                ...
                                <tbody>
                                    ...
                                    foreach ($resultlist as $student_key => $student_value) {
                                        ...
                                        ?>
                                        <tr>
                                            <td class="mailbox-name"> <?php echo $this->customlib->getFullName($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?></td>
