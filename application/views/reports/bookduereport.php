    ...
    <section class="content">
        ...
        <?php ?>
                                                ...
                                                <td><?php
                                                    ...
                                                    ?></td>
                                                <td >
        <?php   if ($book['member_type'] == 'student') {
                                                        echo $this->customlib->getFullName($book['firstname'],$book['middlename'],$book['lastname'],$sch_setting->middlename,$sch_setting->lastname);
                                                    } else {
                                                          echo ucwords($book['fname']) . " " . ucwords($book['lname']);
                                                    }
                                                   ?>
