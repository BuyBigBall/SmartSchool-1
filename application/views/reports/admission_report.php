                    ...
                    <div class="">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php
                                echo $this->lang->line('admission') . " " . $this->lang->line('report');
...
<?php } ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <tr><td></td><td></td><td></td><td></td><td><?php echo $this->lang->line('total_admission_in_this_duration')?>: </td><td > <?php echo $filter_label; ?></td><td><?php echo $count; ?></td><td></td><td></td><td></td><td ></td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
