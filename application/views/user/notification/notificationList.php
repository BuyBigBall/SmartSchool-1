                                ...
                                foreach ($notificationlist as $key => $notification) {
                                    ...
                                    <div class="panel box box-primary">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="pull-right pt5" style="margin-right:20px;">
                                                <a href="<?php echo $uploaddir.$notification['attached_file']; ?>">
                                                <i class="fa fa-download"></i> <?php echo $this->lang->line('download_attachment'); ?> : 
