...
class Exam extends Student_Controller
{
    ...
    public function get_upload_docs($id)
    {
        ...
        if (empty($data)) {
            ...
            $data[0]['teachernote'] = strip_tags(preg_replace('#<br\s*/?>#i', "\n", $data[0]['teachernote']));
            //html_entity_decode($data[0]['teachernote']);
    ...
    public function examresult() {
        ...
        $exam_result_list         = $this->homework_model->getExamResult($class_id, $section_id);
